    ...
    >
      ...
      <Box position="relative" zIndex={1}>
        ...
        <Flex
          ...
          justify="center"
          maxWidth="100%"
          data-cy="about-buttons"
        >
          <Button data-cy="about-btn-tips">Tips op maat</Button>
          <Button data-cy="about-btn-reactie">Snelle reactie</Button>
          <Button data-cy="about-btn-prijs">Goedkope prijs</Button>
        </Flex>
      </Box>
    </Box>
  );
